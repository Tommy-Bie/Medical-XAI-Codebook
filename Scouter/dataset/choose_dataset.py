...
def select_dataset(args):
    ...
    if args.dataset == "ACRIMA":
        # TODO
        dataset_train = ACRIMA(args, train=True, transform=None)
        dataset_val = ACRIMA(args, train=False, transform=None)
        return dataset_train, dataset_val

    if args.dataset == "SkinCon":
        # TODO
        dataset_train = SkinCon(args, train=True, transform=None)
        dataset_val = SkinCon(args, train=False, transform=None)
        return dataset_train, dataset_val
