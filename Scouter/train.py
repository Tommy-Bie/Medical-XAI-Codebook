...
def get_args_parser():
    ...
    parser.add_argument('--num_workers', default=0, type=int)  # TODO: change to 0
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N', help='start epoch')
    parser.add_argument('--resume', default=False, type=str2bool, help='resume from checkpoint')
    parser.add_argument('--vis_image', type=str, help='the image that you want to visualize by CAM')  # TODO: new arg
