...
def get_senn_parser():
    ...
    parser.add_argument('--dataset_dir', default='../../../datasets/SkinCon', help='the path of the dataset')
    ...
    parser.add_argument('--transform', type=str, help='upsample or downsample')
